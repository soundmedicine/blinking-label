...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/soundmedicine/blinking-label'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'soundmedicine' => 'robot-o@hotmail.com' }
  s.source           = { :git => 'https://github.com/soundmedicine/BlinkingLabel.git', :tag => s.version.to_s }
